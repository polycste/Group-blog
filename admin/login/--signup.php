...
<div id="wrapper">
    ...
    <form name="login-form" class="login-form" action="#" method="post">
        ...
        <div class="content">
            ...
            <input name="user_email" type="email" class="input username" placeholder="YOUR E-MAIL"/><br/>
            <?php
            if (!$err2 == "") {
        ...
        <input type="submit" name="submit" value="SignUp" class="button" style="padding-left: 30px;"/><br/><br/><br/>
    </form>
</div>
